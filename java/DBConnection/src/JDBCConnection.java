...
public class JDBCConnection {
    ...
    Statement statement;
    ResultSet resultSet;
    private final String username = "remoto";
    private final String password = "remoto";
    ...
    void createDB() {
        String url = "jdbc:mysql://172.16.102.154:3307";
    ...
    void createTableUsers(){
        String url = "jdbc:mysql://172.16.102.154:3307/school";
